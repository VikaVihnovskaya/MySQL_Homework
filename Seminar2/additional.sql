...
ALTER TABLE posts ADD CONSTRAINT fk_posts_01 FOREIGN KEY (user_id) REFERENCES clients(id);
...
# ALTER TABLE posts ADD CONSTRAINT fk_posts_01 FOREIGN KEY (user_id) REFERENCES clients(id); (используется выше)
...
SELECT posts.*, clients.login, clients.pass
FROM posts, clients
